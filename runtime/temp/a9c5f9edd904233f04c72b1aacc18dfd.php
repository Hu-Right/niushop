<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:48:"template/adminblue\Promotion\updateGroupBuy.html";i:1555393971;s:28:"template/adminblue\base.html";i:1555393968;s:45:"template/adminblue\controlCommonVariable.html";i:1555393965;s:32:"template/adminblue\urlModel.html";i:1555393969;s:51:"template/adminblue\Promotion\goodsSelectDialog.html";i:1555393971;s:34:"template/adminblue\pageCommon.html";i:1555393965;s:34:"template/adminblue\openDialog.html";i:1555393971;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	<dl>
		...
		<dd>
			<input type="text" id="group_name" class="input-common" value="<?php echo $info['group_name']; ?>">
	...
	<dl>
		...
		<dd>
			...
			value="<?php echo date('Y-m-d H:i:s',$info['start_time']); ?>" placeholder="请选择开始时间">
			...
			value="<?php echo date('Y-m-d H:i:s',$info['end_time']); ?>" placeholder="请选择结束时间">
			<p class="error">请输入有效时间</p>
		</dd>
	</dl>
	<dl>
		<dt><span style="color:red;">*</span>&nbsp;&nbsp;最大购买量：</dt>
		<dd><input class="input-mini w70 input-common harf" onkeyup="value=value.replace(/\D/g,'')" type="number" id="max_num" value="<?php echo $info['max_num']; ?>"><em class="unit">件</em>
			<p class="error">请输入最大购买量</p>
		</dd>
	</dl>
<!-- 	<dl>
		<dt><span style="color:red;">*</span>&nbsp;&nbsp;最小购买量：</dt>
		<dd><input class="input-mini w70 input-common" onkeyup="value=value.replace(/\D/g,'')" type="text" id="min_num" value="<?php echo $info['min_num']; ?>"><span class="help-inline">个</span>
			<p class="error">请输入最小购买量</p>
		</dd>
	</dl> -->
	<?php if(is_array($info['price_list']) || $info['price_list'] instanceof \think\Collection || $info['price_list'] instanceof \think\Paginator): $i = 0; $__LIST__ = $info['price_list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?>
	<dl>
		<dt><span style="color:red;">*</span>&nbsp;&nbsp;价格阶梯：</dt>
		<dd>
			<span class="help-inline">最小购买</span> <input class="input-common harf" onkeyup="value=value.replace(/[^\d+(\.\d+)?]/g,'')" type="text" data="num" value="<?php echo $val['num']; ?>"><em class="unit top">件</em><br/>
			<span class="help-inline">购买价格</span> <input class="input-common harf" onkeyup='this.value=this.value.replace(/\D/gi,"")' type="text" data="price" value="<?php echo $val['group_price']; ?>"><em class="unit top">元</em>
			<p class="error"></p>
		</dd>
	</dl>
	<?php endforeach; endif; else: echo "" ;endif; ?>
	<dl>
		<dt>活动说明：</dt>
		<dd>
			<textarea name="store_zy" rows="2" id="remark" class="textarea-common" ><?php echo $info['remark']; ?></textarea>
