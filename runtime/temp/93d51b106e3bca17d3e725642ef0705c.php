<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:35:"template/shop\blue\Login\login.html";i:1555393991;s:32:"template/shop\blue\urlModel.html";i:1555393991;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="footer_min" id="footer">
	...
	<div class="txt" id="bottom_copyright">
		<!-- <p>
			...
			<br/>
			<a href="javascript:void(0)" target="_blank" id="copyright_companyname"></a>
