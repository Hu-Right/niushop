<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:42:"template/adminblue\Promotion\giftList.html";i:1555393971;s:28:"template/adminblue\base.html";i:1555393968;s:45:"template/adminblue\controlCommonVariable.html";i:1555393965;s:32:"template/adminblue\urlModel.html";i:1555393969;s:34:"template/adminblue\pageCommon.html";i:1555393965;s:34:"template/adminblue\openDialog.html";i:1555393971;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<table class="mytable">
	<tr>
		<th width="20%" style="text-align:left;"><button class="btn-common btn-small" onclick="location.href='<?php echo __URL('ADMIN_MAIN/promotion/addgift'); ?>';" style="margin:0 5px 0 0 !important;">添加赠品</button>
			...
			if (data["data"].length > 0) {
				...
				for (var i = 0; i < data["data"].length; i++) {
					...
					if(data['data'][i]['type'] != 1){
						...
						html += '<td><i class="checkbox-common disabled"><input name="sub" type="checkbox" value="'+ data["data"][i]["gift_id"] +'" disabled></i></td>';
					}
