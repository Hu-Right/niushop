<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:45:"template/wap\default_new\Member\myqrcode.html";i:1555393985;s:34:"template/wap\default_new\base.html";i:1555393973;s:38:"template/wap\default_new\urlModel.html";i:1555393984;s:35:"template/wap\default_new\share.html";i:1555393984;s:43:"template/wap\default_new\shareContents.html";i:1555393971;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<?php else: ?>
<img class="shop-qrcode" src="<?php echo __IMG('upload/qrcode/promote_qrcode/spreadQrcode'.$uid.'.jpg'); ?>" style="display:block;width:100%;margin-top:45px;">
<?php endif; ?>  
...
$(function(){
	$.ajax({
		type : "get",
		url : "<?php echo __URL('APP_MAIN/Member/showUserQrcode?shop_id='.$shop_id); ?>",
		success : function(){
			$(".shop-qrcode").attr("src", "<?php echo __IMG('upload/qrcode/promote_qrcode/spreadQrcode'.$uid.'.jpg'); ?>");
		}
	});
	$.ajax({
		type:"post",
