<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:48:"template/adminblue\Promotion\couponGrantLog.html";i:1555393971;s:28:"template/adminblue\base.html";i:1555393968;s:45:"template/adminblue\controlCommonVariable.html";i:1555393965;s:32:"template/adminblue\urlModel.html";i:1555393969;s:34:"template/adminblue\pageCommon.html";i:1555393965;s:34:"template/adminblue\openDialog.html";i:1555393971;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<table class="mytable">
	<tr>
		<th width="20%" style="text-align:left;"><button class="btn-common btn-small" onclick="location.href='<?php echo __URL('ADMIN_MAIN/promotion/addcoupontype'); ?>';" style="margin:0 5px 0 0 !important;">添加优惠券</button>
		</th>
	</tr>
</table>
...
function LoadingInfo(page_index) {
	...
	var coupon_type_id = <?php echo $coupon_type_id; ?>;
	$.ajax({
		type : "post",
		url : "<?php echo __URL('ADMIN_MAIN/promotion/couponGrantLog'); ?>",
		data : {
		...
		success : function(data) {
			if (data["data"].length > 0) {
				...
				for (var i = 0; i < data["data"].length; i++) {
					...
					var nick_name = "---";
					if(item['uid'] > 0){
						nick_name = item['user_info']['nick_name'] == null || item['user_info']['nick_name'] == undefined ? "" : item['user_info']['nick_name'];
					}
