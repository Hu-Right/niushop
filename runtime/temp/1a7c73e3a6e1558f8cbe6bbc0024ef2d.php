<?php if (!defined('THINK_PATH')) exit(); /*a:18:{s:39:"template/shop\blue\Goods\goodsList.html";i:1555393990;s:28:"template/shop\blue\base.html";i:1555393991;s:32:"template/shop\blue\urlModel.html";i:1555393991;s:34:"template/shop\blue\controlTop.html";i:1555393991;s:41:"template/shop\blue\controlHeadSerach.html";i:1555393991;s:43:"template/shop\blue\controlHeadGoodType.html";i:1555393991;s:40:"template/shop\blue\controlCommonNav.html";i:1555393991;s:43:"template/shop\blue\controlRightSidebar.html";i:1555393991;s:60:"template/shop\blue\Goods\controlGoodsCategoryConditions.html";i:1555393990;s:46:"template/shop\blue\Goods\controlGoodsLeft.html";i:1555393991;s:45:"template/shop\blue\Goods\controlGoodList.html";i:1555393990;s:59:"template/shop\blue\Goods\controlPopUpGoodsSkuAttribute.html";i:1555393990;s:41:"template/shop\blue\controlCommonPage.html";i:1555393991;s:44:"template/shop\blue\controlLoveOrHistory.html";i:1555393989;s:45:"template/shop\blue\controlBottomLinkHelp.html";i:1555393991;s:37:"template/shop\blue\controlBottom.html";i:1555393991;s:36:"template/shop\blue\controlLogin.html";i:1555393991;s:37:"template/shop\blue\baidu_js_push.html";i:1555393989;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div id="pagination" class="page" >
	...
	<div class="page-num fr">
		...
		<div id="page_list" style="float: left;<?php echo $path_info; ?>">
			...
			<!-- 总页数小于总页码时就都显示 -->
			<?php if($page_count <= $page_num): $__FOR_START_9745__=1;$__FOR_END_9745__=$page_count+1;for($i=$__FOR_START_9745__;$i < $__FOR_END_9745__;$i+=1){ if($i == $page): ?>
			...
			<?php elseif($page <= ($page_num-1)/2): $__FOR_START_32064__=1;$__FOR_END_32064__=$page_num+1;for($i=$__FOR_START_32064__;$i < $__FOR_END_32064__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info.'?page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 如果总页数等于当前页 或者 总页数小于当前页加上页码总数平均值显示 -->
			<?php elseif($page_count == $page or $page_count <= $page+($page_num-1)/2): $__FOR_START_19286__=$page_count-$page_num+1;$__FOR_END_19286__=$page_count+1;for($i=$__FOR_START_19286__;$i < $__FOR_END_19286__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info.'?page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } ?>
			<!-- 否则就正常显示 -->
			<?php else: $__FOR_START_28889__=$page-($page_num-1)/2;$__FOR_END_28889__=$page+($page_num-1)/2+1;for($i=$__FOR_START_28889__;$i < $__FOR_END_28889__;$i+=1){ if($i == $page): ?>
						<span class="num curr"><a href="javascript:;" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php else: ?>
						<span class="num"><a href="<?php echo __URL('SHOP_MAIN/'.$path_info.'?page='.$i.$query_string); ?>" data-cur-page="<?php echo $i; ?>"><?php echo $i; ?></a></span>
					<?php endif; } endif; ?>
...
<div class="dsc-copyright">
	<div class="w w1200" id="bottom_copyright">
		...
		<p> <a href="javascript:;" target="_blank" class="copyright-logo"><?php echo $web_info['third_count']; ?></a>&nbsp;&nbsp;
			<a href="javascript:void(0)" target="_blank" class="copyright-logo" id="copyright_companyname"></a>&nbsp;&nbsp;<a href="#" id="copyright_meta"></a>
		</p>
