<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:45:"template/adminblue\Config\unionPayConfig.html";i:1555393966;s:28:"template/adminblue\base.html";i:1555393968;s:45:"template/adminblue\controlCommonVariable.html";i:1555393965;s:32:"template/adminblue\urlModel.html";i:1555393969;s:34:"template/adminblue\pageCommon.html";i:1555393965;s:34:"template/adminblue\openDialog.html";i:1555393971;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	<dl>
		<dt>商户号：</dt>
		<dd><input id="merchant_number" type="text" value="<?php echo $config['value']['merchant_number']; ?>" class="input-common long" /></dd>
	</dl>
	<dl>
		<dt>签名证书秘钥：</dt>
		<dd><input id="sign_cert_pwd" type="text" value="<?php echo $config['value']['sign_cert_pwd']; ?>" class="input-common long" /></dd>
	</dl>
	<dl>
		<dt>证书路径：</dt>
		<dd><input id="certs_path" type="text" value="<?php echo $config['value']['certs_path']; ?>" class="input-common long" /></dd>
	</dl>
	<dl>
		<dt>日志路径：</dt>
		<dd><input id="log_path" type="text" value="<?php echo $config['value']['log_path']; ?>" class="input-common long" /></dd>
	</dl>
		<dl>
		<dt>手续费：</dt>
		<dd>
			<input id="service_charge" type="number" value="<?php echo $config['value']['service_charge']; ?>" class="input-common harf" 
			/><em class="unit">元</em>
		</dd>
	</dl>
	<dl>
...
function setConfigAjax(){
	...
	$.ajax({
		type:"post",
		url:"<?php echo __URL('ADMIN_MAIN/config/unionPayConfig'); ?>",
		data:{
