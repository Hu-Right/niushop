<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:46:"template/adminblue\Promotion\getTopicList.html";i:1555393971;s:28:"template/adminblue\base.html";i:1555393968;s:45:"template/adminblue\controlCommonVariable.html";i:1555393965;s:32:"template/adminblue\urlModel.html";i:1555393969;s:34:"template/adminblue\pageCommon.html";i:1555393965;s:34:"template/adminblue\openDialog.html";i:1555393971;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<table class="mytable">
	<tr>
		<th width="20%" style="text-align: left;">
			<button class="btn-common btn-small" onclick="location.href='<?php echo __URL('ADMIN_MAIN/promotion/addTopic'); ?>';" style="margin:0 5px 0 0 !important;">添加专题活动</button>
...
function LoadingInfo(page_index) {
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('ADMIN_MAIN/promotion/TopicList'); ?>",
		data : {
		...
		success : function(data) {
			if (data["data"].length > 0) {
				...
				for (var i = 0; i < data["data"].length; i++) {
					...
					html += '<td>';
					html += '<a target="_blank" href="'+__URL('SHOP_MAIN/goods/promotionTopicGoods?topic_id='+data["data"][i]["topic_id"])+'">预览</a>';
...
function delTopic(topic_id){
	$.ajax({
		type:"post",
		url : "<?php echo __URL('ADMIN_MAIN/promotion/delTopic'); ?>",
		data : { "topic_id" : topic_id.toString() },
		dataType : "json",
		success : function(data) {
			if (data["code"] > 0) {
				showMessage('success', data["message"],"<?php echo __URL('ADMIN_MAIN/promotion/topicList'); ?>");
			}else if(data["code"] == -1){
...
function closeTopic(topic_id){
	$.ajax({
		type:"post",
		url : "<?php echo __URL('ADMIN_MAIN/promotion/closeTopic'); ?>",
...
function topicInfo(topic_id){
	...
	$.ajax({
		type:"get",
		url : "<?php echo __URL('ADMIN_MAIN/promotion/getTopicDetail'); ?>",
		data : { "topic_id" : topic_id },
		success : function(data) {
