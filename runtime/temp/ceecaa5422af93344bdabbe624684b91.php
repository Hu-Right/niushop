...
<div class="set-style">
    ...
    <dl>
		...
		<dd>
			...
			<p class="text-success">
				<span class="muted">request合法域名：</span><?php echo $url; ?>
			</p>
			<p class="text-success">
				<span class="muted">uploadFile合法域名：</span><?php echo $url; ?>
			</p>
			<p class="text-success">
				<span class="muted">downloadFile合法域名：</span><?php echo $url; ?>
			</p>
			<p>服务器域名设置完毕！</p>
		</dd>
	</dl>    
